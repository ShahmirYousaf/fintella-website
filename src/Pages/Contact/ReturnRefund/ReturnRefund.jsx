            ...
            <ol>
              <li>
                ...
                <ul className="circled-bullets">
                  <li>Refunds are only applicable if the product has not been accessed, downloaded, or viewed beyond 10% of its content.</li>
                  <li>Courses with downloadable resources are non-refundable once the resources have been accessed.</li>
                  <li>If you encounter technical issues that prevent access, our support team must be contacted within 7 days of purchase for resolution or a possible refund.</li>
                </ul>
              </li>
              <li>
                <strong className="underline">Physical Products (Tech Gadgets, Accessories, etc.):</strong>
                <ul className="circled-bullets">
                  <li>The product must be unused, undamaged, and returned in its original packaging.</li>
                  <li>All accompanying items such as user manuals, warranty cards, invoices, and accessories must be included.</li>
                </ul>
              </li>
              <li>
                <strong className="underline">Packaging Guidelines:</strong>
                <ul className="circled-bullets">
                  <li>For physical products, return the item in its original and undamaged manufacturer’s packaging/box.</li>
                  <li>Avoid placing tape or stickers directly on the manufacturer’s packaging.</li>
                </ul>
              </li>
              <li>
                <strong className="underline">Important Instructions:</strong>
                <ul>
                  <li>Clearly mention your Order Number and Return Tracking Number on the return package to avoid delays or inconvenience.</li>
                </ul>
              </li>
            </ol>
            <div className="note">
